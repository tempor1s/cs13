...
class BinaryTreeNode(object):
    ...
    def height(self):
        ...
        O(n) because we to traverse every node in the tree to find the 'tallest' one"""
...
class BinarySearchTree(object):
    ...
    def contains(self, item):
        ...
        O(h) Where H is the height of the binary tree, since we would have to iterate to the deepest node if the item isnt there"""
